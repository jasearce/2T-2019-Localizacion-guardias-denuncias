...
public class Registra_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registra__admin);
            ...
            txtIniciarSesion.setOnClickListener(v -> {
                startActivity(new Intent(Registra_Admin.this, LoginAdminActivity.class));
                finish();
            });
    ...
    private boolean validarFormulario(){
        ...
        if(TextUtils.isEmpty(name)){
            Toast.makeText(Registra_Admin.this, "No ha ingresado datos en el campo",
        ...
        if(TextUtils.isEmpty(email)){
            ...
            if(!Patterns.EMAIL_ADDRESS.matcher(email.trim()).matches()){
                ...
                Toast.makeText(Registra_Admin.this, "Formato incorrecto del email", Toast.LENGTH_SHORT).show();
                mEmailEt.setFocusable(true);
                valido = false;
            }
        }
        ...
        if(TextUtils.isEmpty(repPass)){
            ...
            if(!repPass.equals(password)){
                Toast.makeText(Registra_Admin.this, "Contrasenas no coinciden", Toast.LENGTH_SHORT).show();
                mRepPassEt.setFocusable(true);
                valido = false;
            }
        }
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Registra_Admin.this, "Autenticacion falló",
                                Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(e -> {
            progressDialog.dismiss();
            Toast.makeText(Registra_Admin.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
        });
    }
}
