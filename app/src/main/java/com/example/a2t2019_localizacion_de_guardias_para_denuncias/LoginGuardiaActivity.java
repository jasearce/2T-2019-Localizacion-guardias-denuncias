    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(v -> {
            ...
            if(TextUtils.isEmpty(email) || TextUtils.isEmpty(password)){
                Toast.makeText(LoginGuardiaActivity.this, "Por favor ingrese su usuario y contraseña",
    ...
    private void login(String email, String password){
        ...
        Task<AuthResult> authResultTask = mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, task -> {
            if (task.isSuccessful()) {
                ...
                progressDialog.dismiss();
                Toast.makeText(LoginGuardiaActivity.this, "Por favor revise que sus credenciales sean correctas.",
                        Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(e -> Toast.makeText(LoginGuardiaActivity.this, "" + e.getMessage(),
                Toast.LENGTH_SHORT).show());
    }
}
